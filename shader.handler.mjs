  ...
  function p(o) {
    ...
    a.nativeMethods.defineProperty(o, '__uv', { value: e, enumerable: !1 }),
      ...
      (e.location = a.location.emulate(
        (t) =>
          t === 'about:srcdoc' ? new URL(t) : (t.startsWith('blob:') && (t = t.slice(5)), new URL(e.sourceUrl(t))),
        (t) => e.rewriteUrl(t)
      ))
    let u = k
    if (
      ...
      for (let t in o.localStorage)
        t.startsWith(i + e.location.origin + '@') &&
          (e.localStorageObj[t.slice((i + e.location.origin + '@').length)] = o.localStorage.getItem(t))
      e.lsWrap = a.storage.emulate(a.storage.localStorage, e.localStorageObj)
    }
    if (o.sessionStorage) {
      for (let t in o.sessionStorage)
        t.startsWith(i + e.location.origin + '@') &&
          (e.sessionStorageObj[t.slice((i + e.location.origin + '@').length)] = o.sessionStorage.getItem(t))
    ...
    a.nativeMethods.defineProperty(e.meta, 'base', {
      ...
      a.document.on('setCookie', (t) => {
        ...
        r.path || (r.path = '/'),
          ...
          e.cookie.validateCookie(r, e.meta, !0) && (u.length && (u += '; '), (u += `${r.name}=${r.value}`)),
      ...
      a.element.on('getOuterHTML', (t) => {
        switch (t.that.tagName) {
          case 'HEAD':
            t.data.value = e
              .sourceHtml(t.data.value.replace(/<head(.*)>(.*)<\/head>/s, '<op-head$1>$2</op-head>'))
              .replace(/<op-head(.*)>(.*)<\/op-head>/s, '<head$1>$2</head>')
            break
          case 'BODY':
            t.data.value = e
              .sourceHtml(t.data.value.replace(/<body(.*)>(.*)<\/body>/s, '<op-body$1>$2</op-body>'))
      ...
      a.element.hookProperty([y, M, j, g, _, v, H, n, x, S], 'src', {
        ...
        set: (t, r, [l]) => {
          if (new String(l).toString().trim().startsWith('blob:') && r instanceof g)
            return a.element.setAttribute.call(r, e.attributePrefix + '-attr-src', l), t.call(r, e.blobUrls.get(l) || l)
    ...
    if (
      ...
      a.attribute.on('getValue', (t) => {
        a.element.hasAttribute.call(t.that.ownerElement, e.attributePrefix + '-attr-' + t.data.name) &&
          (t.data.value = a.element.getAttribute.call(t.that.ownerElement, e.attributePrefix + '-attr-' + t.data.name))
      }),
      ...
      a.url.on('createObjectURL', (t) => {
        ...
        if (r.startsWith('blob:' + location.origin)) {
          let l =
            'blob:' +
            (e.meta.url.href !== 'about:blank' ? e.meta.url.origin : o.parent.__uv.meta.url.origin) +
      ...
      a.style.on('getPropertyValue', (t) => {
        a.style.dashedUrlProps.includes(t.data.property) &&
          t.respondWith(e.sourceCSS(t.target.call(t.that, t.data.property), { context: 'value', ...e.meta }))
      }),
      'CSS2Properties' in o)
    )
      ...
      a.nativeMethods.defineProperty(o.Object.prototype, e.methods.setSource, {
        value: function (t) {
          return a.nativeMethods.isExtensible(this)
            ? (a.nativeMethods.defineProperty(this, e.methods.source, { value: t, writable: !0, enumerable: !1 }), this)
            : this
        },
        enumerable: !1,
      }),
